 ...
 * PoliceTicket.java
 *
 * Created on Feb 23, 2012, 10:55:13 PM
 */
package javaproject;
 ...
 * @author Painmachine
 */
public class PoliceTicket extends JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javaproject.Main.class).getContext().getResourceMap(PoliceTicket.class);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ticketNumberField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(trnNumberField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(badgeNumberField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(offenseNumberField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(offenseNameField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(dateOfOffenseField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(placeOfOffenseField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(descriptionField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(fineField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(pointsField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)
                            .addComponent(paymentStatusField, javax.swing.GroupLayout.DEFAULT_SIZE, 723, Short.MAX_VALUE)))
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                PoliceTicket.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                PoliceTicket.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                PoliceTicket.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == jButton1) {
                PoliceTicket.this.jButton1ActionPerformed(evt);
            }
            else if (evt.getSource() == jButton2) {
                PoliceTicket.this.jButton2ActionPerformed(evt);
            }
            else if (evt.getSource() == jButton3) {
                PoliceTicket.this.jButton3ActionPerformed(evt);
            }
            else if (evt.getSource() == jButton4) {
                PoliceTicket.this.jButton4ActionPerformed(evt);
            }
        }
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        ...
        this.ticketNumberField.setEditable(true);
        this.badgeNumberField.setEditable(true);
        this.dateOfOffenseField.setEditable(true);
        this.descriptionField.setEditable(true);
        this.fineField.setEditable(true);
        this.offenseNameField.setEditable(true);
        this.offenseNumberField.setEditable(true);
        this.paymentStatusField.setEditable(true);
        this.pointsField.setEditable(true);
        this.placeOfOffenseField.setEditable(true);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"The record has been saved."); 
        
        this.trnNumberField.setEditable(false);
        this.ticketNumberField.setEditable(false);
        this.badgeNumberField.setEditable(false);
        this.dateOfOffenseField.setEditable(false);
        this.descriptionField.setEditable(false);
        this.fineField.setEditable(false);
        this.offenseNameField.setEditable(false);
        this.offenseNumberField.setEditable(false);
        this.paymentStatusField.setEditable(false);
        this.pointsField.setEditable(false);
        this.placeOfOffenseField.setEditable(false);
...
//            java.util.logging.Logger.getLogger(PoliceTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
